  ...
  <div className="max-w-screen-2xl flex flex-row justify-between items-center w-screen">
    ...
    <div className='px-4 h-12 flex flex-1 flex-row justify-between items-center'>
      ...
      <div className='flex flex-row justify-between items-center gap-x-8 text-xl'>
        { hasAccessTo(accesses,'holding-config') && <NavLink to='/Holding' className={`text-gray-400 text-sm`}>
        {({ isActive }) => {
          return <div className={`transition ease-in-out ${isActive && 'scale-125 text-mila_orange font-bold'}`}>Holding</div>
        }
        }
        </NavLink>}
        { hasAccessTo(accesses,'commercial') && <NavLink to='/Commercial' className={`text-gray-400 text-sm`}>
        {({ isActive }) => {
          return <div className={`transition ease-in-out ${isActive && 'scale-125 text-mila_orange font-bold'}`}>Commercial</div>
        }
        }
        </NavLink>}
        ...
        { hasAccessTo(accesses,'operational') && <NavLink to='/Operational' className={`text-gray-400 text-sm`}>
          {({ isActive }) => (
            <div className={`transition ease-in-out ${isActive && 'scale-125 text-mila_orange font-bold'}`}>Operational</div>
            )
          }</NavLink>}
        ...
        { hasAccessTo(accesses,'financial') && <NavLink to='/Financial' className={`text-gray-400 text-sm`}>
          {({ isActive }) => (
            <div className={`transition ease-in-out ${isActive && 'scale-125 text-mila_orange font-bold'}`}>Financial</div>
            )
          }</NavLink>}
      </div>
