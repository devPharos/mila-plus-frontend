...
export default function GroupsPreview({ id, handleOpened, setOpened, defaultFormType = 'preview' }) {
    ...
    const filialTypeOptions = [{ value: 'Holding', label: 'Holding' }, { value: 'Own', label: 'Own' }, { value: 'Participation', label: 'Participation' }]
    ...
    return pageData && <Preview formType={formType} fullscreen={fullscreen}>
                            ...
                            <InputContext.Provider value={{ id, setSuccessfullyUpdated, fullscreen, setFullscreen, successfullyUpdated, handleCloseForm }}>
                                ...
                                <InputLineGroup title='GENERAL' activeMenu={activeMenu === 'general'}>
                                    <InputLine title='General Data'>
                                        ...
                                        {/* <Input type='text' readOnly name='filial_type' required title='Filial Type' grow defaultValue={pageData.filial_type} InputContext={InputContext} /> */}
                                        <Select name='filial_type' title='Filial Type' options={filialTypeOptions} defaultValue={pageData.filial_type} InputContext={InputContext} />
                                    </InputLine>
