...
export default function AdministrativeStaffs() {
  ...
  useEffect(() => {
    ...
    async function getData() {
      ...
      const gridDataValues = data.map(({ id, name, last_name, academic_formation, canceled_at }) => {
        const ret = { show: true, id, fields: [name, last_name, academic_formation], canceled: canceled_at }
        return ret
      })
