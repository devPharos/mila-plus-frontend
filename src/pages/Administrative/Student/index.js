...
export default function AdministrativeStudent() {
  ...
  const [excelVacationFilter, setExcelVacationFilter] = useState(excelVacationFilterData);
  ...
  const [excelMedicalExcuseFilter, setExcelMedicalExcuseFilter] = useState(excelMedicalExcuseFilterData);
