...
export default function TransferDSOOutside({ access = null, handleOpened, setOpened, defaultFormType = 'preview' }) {
                                        ...
                                        {pageData.activeMenu === 'transfer-dso' && <InputLineGroup title='Student Information' activeMenu={pageData.activeMenu === 'transfer-dso'}>
                                            ...
                                            <Scope path={`students`}>
                                                <InputLine title='Student Information'>
                                                    ...
                                                    <Input type='text' readOnly disabled name='nsevis' required grow title='NSEVIS' defaultValue={pageData.students.nsevis} InputContext={InputContext} />
                                                </InputLine>
                                            </Scope>
                                            ...
                                            <Scope path={`enrollmenttransfers`}>
                                                ...
                                                <InputLine>
                                                    <SelectPopover name='has_student_maintained_full_time_studies' required grow title='Has the student maintained full time studies as defined in the regulations since obtaining status?' options={yesOrNoOptions} defaultValue={pageData.enrollmenttransfers ? yesOrNoOptions.find(type => type.value === pageData.enrollmenttransfers.has_student_maintained_full_time_studies) : null} InputContext={InputContext} />
                                                    <SelectPopover name='is_student_eligible_to_transfer' required grow title='If accepted, is the student eligible to transfer to MILA International Language Academy - Orlando?' options={yesOrNoOptions} defaultValue={pageData.enrollmenttransfers ? yesOrNoOptions.find(type => type.value === pageData.enrollmenttransfers.is_student_eligible_to_transfer) : null} InputContext={InputContext} />
                                                </InputLine>
                                                <InputLine>
                                                ...
                                                <InputLine>
                                                    <Input type='text' name='previous_school_phone' required grow title='Phone Number' isPhoneNumber defaultValue={pageData.enrollmenttransfers ? pageData.enrollmenttransfers.previous_school_phone : null} InputContext={InputContext} />
                                                    <Input type='text' name='previous_school_address' required grow title='Address' defaultValue={pageData.enrollmenttransfers ? pageData.enrollmenttransfers.previous_school_address : null} InputContext={InputContext} />
                                                    <Input type='text' name='previous_school_zip' required grow title='Zip Code' isZipCode defaultValue={pageData.enrollmenttransfers ? pageData.enrollmenttransfers.previous_school_zip : null} InputContext={InputContext} />
