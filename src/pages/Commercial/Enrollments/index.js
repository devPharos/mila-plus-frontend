...
export default function Enrollments() {
  ...
  return <div className='h-full bg-white flex flex-1 flex-col justify-start items-start rounded-tr-2xl px-4'>
    ...
    <Filters access={hasAccessTo(accesses, currentPage.path.split('/')[1], currentPage.alias)} handleNew={null} search handleFilters={handleFilters} gridHeader={gridHeader} gridData={gridData} setGridHeader={setGridHeader} activeFilters={activeFilters} />
