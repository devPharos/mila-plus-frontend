...
export default function CommercialProspects() {
  ...
  useEffect(() => {
    async function getData() {
      ...
      const gridDataValues = data.map(({ id, name, last_name, email, phone, salesagent_id, preferred_contact_form, canceled_at }) => {
        return { show: true, id, fields: [name, last_name, email, phone, salesagent_id, preferred_contact_form], canceled: canceled_at }
      })
