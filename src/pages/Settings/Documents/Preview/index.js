                        ...
                        >
                              ...
                              defaultValue={
                                pageData.origin && pageData.type
                                  ? options
                                      ...
                                      .subtypes.filter(
                                        (subtype) =>
                                          subtype.value === pageData.subtype
                                      )
                                  : []
                              }
                              options={
                          ...
                          <InputLine>
                            ...
                            <SelectPopover
                              ...
                              title="Required"
                              isSearchable
                              defaultValue={yesOrNoOptions.filter(
                                (required) =>
                                  required.value === pageData.required
                              )}
                            ...
                            <SelectPopover
                              ...
                              defaultValue={yesOrNoOptions.filter(
                                (multiple) =>
                                  multiple.value === pageData.multiple
                              )}
                              options={yesOrNoOptions}
                              InputContext={InputContext}
                            />
